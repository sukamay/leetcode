...
#include "Header_685.h"
#include "Header_1008.h"
#include "Header_449.h"
#include "Header_834.h"
#include "Header_726.h"
#include "Header_472.h"
#include "Header_514.h"
#include "Header_65.h"
#include "Header_273.h"
#include "Header_233.h"
...
int main(int argc, const char * argv[]) {
    ...
    //    Q233:
/*
    vector<int> vec{0,1,2,9,10,99,100,103,132,1032,9999,10000,10001};
    for(int a:vec){
        cout << a << ":\t" << countDigitOne(a) << endl;
    }
*/
    //    Q273:
/*
    vector<int> vec{1000000,100000,123450,190};
    for(int &num:vec){
...
*/
/*
    vector<string> vec{"0.e1","0"," 0.1","abc","1 a","2e10"," 1e"," e2","-90e3","3e-1","-1e-2","99e2.5","53.5e6","-+3","--5","97e9e7"," 2e 4","..2"};
    for(string &s:vec){
...
//    string formula = "Mg(OH)2";
    ...
    cout<<"count of atoms: "<<countOfAtoms(formula)<<endl;
*/
    //    Q834:
/*
    vector<vector<int>> edges{{0,1},{0,2},{2,3},{2,4},{2,5}};
    auto vec = sumOfDistancesInTree(6, edges);
    print(vec);
*/
    //    Q449:
/*
//    string data = "2,1,3,";
    string data = "9,7,4,1,8,12,11,10,20,";
...
/*
    ...
    auto root = bstFromPreorder(vec);
 */
    //    Q685:
/*
//    vector<vector<int> > vec{{4,2},{1,5},{5,2},{5,3},{2,4}};
    vector<vector<int>> vec{{1,2},{1,3},{2,3}};
    auto res = findRedundantDirectedConnection(vec);/
 */
    return 0;
}
